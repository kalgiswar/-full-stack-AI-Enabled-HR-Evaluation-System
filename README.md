<div align="center">
  ...
  <h3 align="center">Hireguard: A job interview preparation platform powered by Vapi AI Voice agents</h3>
...
Hireguard is a **Full-Stack AI Enabled HR Evaluation System** designed to manage the entire recruitment journey—from resume upload to the final hiring decision. 

Unlike traditional applicant tracking systems, Hireguard uses a **Multi-Modal Assessment Engine** to evaluate "job-readiness" through scenario-based MCQs, coding challenges, and psychometric profiling. It features a robust **Integrity Shield** for proctoring and an **Explainable AI Decision Engine** that provides transparent "Hire/No-Hire" rationales, ensuring a fair and data-driven hiring process.
...
## <a name="features">🔋 Core Building Blocks</a>

👉 **1. Multi-Modal Assessment Engine**: A versatile testing interface for "job-readiness."
   - **Scenario-based MCQs**: Situational judgment tests.
   - **Coding Sandbox**: Functional IDE with hidden test cases.
   - **Text-based Responses**: Open-ended communication questions.
   - **Slider-based Inputs**: Psychometric mapping.

👉 **2. Dual-Track Assessment Logic**:
   - **Technical Assessment**: Hard skills (syntax, logic, system design).
   - **Psychometric Assessment**: Soft skills (EQ, resilience, culture fit).

👉 **3. The Integrity Shield (Proctoring)**:
   - **Visual Monitoring**: Webcam detection for multiple faces or absence.
   - **Environmental Control**: Anti-tab switching and copy-paste detection.
   - **Audit Trail**: Timestamped logs of suspicious events.

👉 **4. Smart Resume Shortlisting**:
   - **Parsing Logic**: Extract entities (skills, exp, education).
   - **Scoring Heuristics**: Match against Job Descriptions (JD).
   - **Ranking**: Auto-sort into "High Match," "Potential," and "Reject."

👉 **5. The "Explainable AI" Decision Engine**:
   - **Automated Decision**: Final "Hire/No-Hire" recommendation.
   - **The "Why"**: Text-based justification for the decision.
